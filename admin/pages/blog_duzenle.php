...
<head>
    ...
    <title>Menü Düzenle | Panel </title>
...
$cek = $db->prepare("SELECT * FROM `products` WHERE `id` = :id ");
...
if(@$_POST["submit"]){
   ...
   $guncelle = $db->prepare("UPDATE `products` SET `product_name` = :product_name, `img_url` = :img_url, `price` = :price, `aktif` = :aktif WHERE `id` =:id");
   $guncelle->bindValue(":product_name", $product_name, PDO::PARAM_STR);
   $guncelle->bindValue(":img_url", $img_url, PDO::PARAM_STR);
   $guncelle->bindValue(":price", $price, PDO::PARAM_INT);
                                ...
                                <div class="col-lg-6">
                                    <form role="form"action="" method ="POST" enctype ="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" name="product_name" value="<?= $row["product_name"] ?>" placeholder="Ürün ismi">
                                        </div>
                                        <div class="form-group">
                                            <label>Ürün Fotoğrafı</label>
                                            <input class="form-control" name ="img_url" value="<?= $row["img_url"] ?>" placeholder="Fotoğraf Url">
                                        </div>
                                     
                                    
                                        <div class="form-group">
                                            <label>Ürün Fiyatı</label>
                                            <input class="form-control"  name="price"  value="<?= $row["price"] ?>₺"placholder="Fiyat">
                                        </div>
