                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                            <a href ="mesaj_detay.php?id=<?= $row["id"] ?>"onclick="return confirm('Düzenlemek istediğinizden emin misiniz?')" class="btn btn-warning btn-xs  " style ="margin-right: 15px;">Oku</a>
                                            <a href ="mesajlar.php?is=sil&id=<?= $row["id"] ?>" onclick="return confirm('Silmek istediğinizden emin misiniz?')" class="btn btn-danger btn-xs  " style ="margin-right: 15px;">Sil</a>
